...
class Game:
    ...
    def draw(self):
        ...
        #self.screen.blit(pygame.image.load('C:/Users/Vinícius/OneDrive/Área de Trabalho/João/MODULO II/Repositório clone/Repositorio do DINO/Dino-Joao/dino_runner/assets/Imagem/back.png'), (0, 0))
